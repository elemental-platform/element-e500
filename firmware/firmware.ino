...
//#define NODEID              6 // must be unique for each node on same network (range up to 254, 0 is broadcast)
uint16_t NODEID =             6; // same as above, but supports 10bit addresses (up to 1023 node IDs)
#define NETWORKID             1
#define GATEWAYID             1
